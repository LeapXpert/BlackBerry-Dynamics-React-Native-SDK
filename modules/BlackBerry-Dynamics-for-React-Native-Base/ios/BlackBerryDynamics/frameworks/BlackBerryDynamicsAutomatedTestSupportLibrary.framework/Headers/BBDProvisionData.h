...
typedef NS_ENUM(NSInteger, BBDActivationType) {
    BBDIdpActivationType,  // local user password will be used for provisioning
    BBDAccessKeyActivationType,    // access key will be used for provisioning
    BBDPasswordActivationType, // activation password will be used for provisioning
    BBDUnknownActivationType
} NS_SWIFT_NAME(BBDActivationType);

@interface BBDProvisionData : NSObject

@property (nonatomic, readonly)  BBDActivationType activationType;
